...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT sinif,COUNT(islemno) FROM ogrenci o JOIN islem i ON o.ogrno = i.ogrno WHERE sinif IN('10A', '10B') GROUP BY sinif";
